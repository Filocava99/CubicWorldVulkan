...
public class ShadowRenderActivity {
    ...
    private static final String SHADOW_FRAGMENT_SHADER_FILE_GLSL = "src/main/resources/shaders/shadow_fragment.glsl";
    private static final String SHADOW_FRAGMENT_SHADER_FILE_SPV = SHADOW_FRAGMENT_SHADER_FILE_GLSL + ".spv";
    private static final String SHADOW_GEOMETRY_SHADER_FILE_GLSL = "src/main/resources/shaders/shadow_geometry.glsl";
    private static final String SHADOW_GEOMETRY_SHADER_FILE_SPV = SHADOW_GEOMETRY_SHADER_FILE_GLSL + ".spv";
    private static final String SHADOW_VERTEX_SHADER_FILE_GLSL = "src/main/resources/shaders/shadow_vertex.glsl";
