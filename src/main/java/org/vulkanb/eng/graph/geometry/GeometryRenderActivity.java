...
public class GeometryRenderActivity {
    ...
    private static final String GEOMETRY_FRAGMENT_SHADER_FILE_GLSL = "src/main/resources/shaders/geometry_fragment.glsl";
    private static final String GEOMETRY_FRAGMENT_SHADER_FILE_SPV = GEOMETRY_FRAGMENT_SHADER_FILE_GLSL + ".spv";
    private static final String GEOMETRY_VERTEX_SHADER_FILE_GLSL = "src/main/resources/shaders/geometry_vertex.glsl";
