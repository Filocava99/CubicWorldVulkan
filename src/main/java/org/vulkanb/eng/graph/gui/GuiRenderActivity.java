...
public class GuiRenderActivity {
    ...
    private static final String GUI_FRAGMENT_SHADER_FILE_GLSL = "src/main/resources/shaders/gui_fragment.glsl";
    private static final String GUI_FRAGMENT_SHADER_FILE_SPV = GUI_FRAGMENT_SHADER_FILE_GLSL + ".spv";
    private static final String GUI_VERTEX_SHADER_FILE_GLSL = "src/main/resources/shaders/gui_vertex.glsl";
